...
export class ResultadoDetailPage {
  ...
  constructor(public navCtrl: NavController, 
    ...
    loading.present();
    this.http.post("https://sisdedetizadora.com.br/seam/resource/rest/baseConhecimentoMobile/abrirConteudoBase", JSON.stringify(post), { headers: { 'Content-Type': 'application/json' } })
      .subscribe((data) => {
